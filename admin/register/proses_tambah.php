...
if ($foto  != "") {
    ...
    if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
        ...
        if (!$result) {
            ...
            echo "<script>alert('Register Berhasil !');window.location='../login/index.php';</script>";
        }
    } else {
        //jika file ekstensi tidak jpg dan png maka alert ini yang tampil
        echo "<script>alert('Ekstensi Gambar Yang Boleh Hanya jpg atau png.');window.location='../login/index.php';</script>";
    }
} else {
