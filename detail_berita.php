...
$detail = mysqli_query($koneksi, "SELECT * FROM berita JOIN kategori ON berita.id_kategori=kategori.id_kategori WHERE id_berita='$id_berita'");
...
<div class="container-fluid py-5">
    <div class="container py-5">
        ...
        <div class="row g-4">
            <div class="col-lg-8">
                <div class="mb-4">
                    <a href="#" class="h1 display-5"><?= $d['judul_berita'] ?></a>
                </div>
                <div class="position-relative rounded overflow-hidden mb-3">
                    <img src="admin/assets/images/<?= $d['gambar_berita'] ?>" class="img-zoomin img-fluid rounded w-100" alt="">
