                        ...
                        <div class="col-4">
                            ...
                            <div class="rounded-circle position-relative">
                                <div class="overflow-hidden rounded-circle">
                                    <img src="admin/assets/images/<?= $t['foto'] ?>" class="img-zoomin rounded-circle w-100" style="height: 77px;" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="col-8">
                            <div class="features-content d-flex flex-column">
                                ...
                                <p class="text-uppercase mb-2"><?= $t['jabatan'] ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-4 align-items-center">
                            <div class="col-md-6">
                                <div class="rounded overflow-hidden">
                                    <img src="admin/assets/images/<?= $b['gambar_berita'] ?>" class="img-fluid rounded img-zoomin w-100" style="height: 150px;" alt="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="d-flex flex-column">
                                    <a href="#" class="h3">"<?= $b['judul_berita'] ?>"</a>
                            ...
                            <div class="row g-4 align-items-center">
                                <div class="col-5">
                                    <div class="overflow-hidden rounded">
                                        <img src="assets/img/news-3.jpg" class="img-zoomin img-fluid rounded w-100" alt="">
                                    </div>
                                </div>
                                <div class="col-7">
                                    <div class="features-content d-flex flex-column">
    ...
    <div class="container py-5">
        ...
        <div class="latest-news-carousel owl-carousel">
            ...
            if (isset($_GET['nama_kategori'])) {
                ...
                $latest = mysqli_query($koneksi, "SELECT * FROM berita JOIN kategori ON berita.id_kategori=kategori.id_kategori WHERE nama_kategori='$nama_kategori' ORDER BY id_berita DESC");
                //looping data dengan while
            } else {
                $latest = mysqli_query($koneksi, "SELECT * FROM berita JOIN kategori ON berita.id_kategori=kategori.id_kategori  ORDER BY id_berita DESC");
            }
                ...
                <div class="latest-news-item">
                    <div class="bg-light rounded">
                        <div class="rounded-top overflow-hidden">
                            <img src="admin/assets/images/<?= $m['gambar_berita'] ?>" class="img-zoomin img-fluid rounded-top w-100 " style="height: 300px;"
                                alt="">
                        </div>
                        <div class="d-flex flex-column p-4">
                            <a href="?page=detail_berita&id_berita=<?= $m['id_berita'] ?>" class="h6"><?= $m['judul_berita'] ?></a>
                            <div class="d-flex justify-content-between">
                                <a href="#" class="small text-body link-hover"><?= $m['nama_kategori'] ?></a>
                                <small class="text-body d-block"><i class="fas fa-calendar-alt me-1"></i> <?= date('M,d Y', strtotime($m['tgl_berita'])) ?></small>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-4">
                <div class="col-lg-8 col-xl-9">
                            ...
                            <ul class="nav nav-pills d-inline-flex text-center">
                                <li class="nav-item mb-3">
                                    <a class="d-flex py-2 bg-light rounded-pill me-2" data-bs-toggle="pill" href="#tab-2">
                                        <span class="text-dark" style="width: 100px;"><?= $k['nama_kategori'] ?></span>
                                    </a>
                                </li>
                            <?php } ?>
                            </ul>
                    ...
                    <div class="whats-carousel owl-carousel">
                        ...
                        <?php
                        include "koneksi.php";
                        $most = mysqli_query($koneksi, "SELECT * FROM berita JOIN kategori ON berita.id_kategori=kategori.id_kategori ORDER BY id_berita DESC");
                        //looping data dengan while
                        ...
                        ?>
                            ...
                            <div class="latest-news-item">
                                <div class="bg-light rounded">
                                    <div class="rounded-top overflow-hidden">
                                        <img src="admin/assets/images/<?= $m['gambar_berita'] ?>" class="img-zoomin img-fluid rounded-top w-100" style="height: 300px;" alt="">
                                    </div>
                                    <div class="d-flex flex-column p-4">
                                        <a href="?page=detail_berita&id_berita=<?= $m['id_berita'] ?>" class="h4"><?= $m['judul_berita'] ?></a>
                                        <div class="d-flex justify-content-between">
                                            <a href="#" class="small text-body link-hover"><?= $m['nama_kategori'] ?></a>
                                            <small class="text-body d-block"><i class="fas fa-calendar-alt me-1"></i><?= date('M,d Y', strtotime($m['tgl_berita'])) ?></small>
                                        </div>
                        ...
                        <div class="row g-4">
                            <div class="col-lg-6">
                                <div class="lifestyle-item rounded">
                                    <img src="assets/img/lifestyle-1.jpg" class="img-fluid w-100 rounded" alt="">
                            ...
                            <div class="col-lg-6">
                                <div class="lifestyle-item rounded">
                                    <img src="assets/img/lifestyle-2.jpg" class="img-fluid w-100 rounded" alt="">
                                    <div class="lifestyle-content">
                                        <div class="mt-auto">
                                            <a href="#" class="h4 text-white link-hover">There are many variations of passages of Lorem Ipsum available,</a>
                                            <div class="d-flex justify-content-between mt-4">
                                    ...
                                    <div class="col-12">
                                        <div class="row g-4 align-items-center features-item">
                                            <div class="col-4">
                                                <div class="rounded-circle position-relative">
                                                    <div class="overflow-hidden rounded-circle">
                                                        <img src="assets/img/features-sports-1.jpg" class="img-zoomin img-fluid rounded-circle w-100" alt="">
                                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="row g-4 align-items-center features-item">
                                            <div class="col-4">
                                                <div class="rounded-circle position-relative">
                                                    <div class="overflow-hidden rounded-circle">
                                                        <img src="assets/img/features-technology.jpg" class="img-zoomin img-fluid rounded-circle w-100" alt="">
                                                    </div>
                                                    <span class="rounded-circle border border-2 border-white bg-primary btn-sm-square text-white position-absolute" style="top: 10%; right: -10px;">3</span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="row g-4 align-items-center features-item">
                                            <div class="col-4">
                                                <div class="rounded-circle position-relative">
                                                    <div class="overflow-hidden rounded-circle">
                                                        <img src="assets/img/features-fashion.jpg" class="img-zoomin img-fluid rounded-circle w-100" alt="">
                                                    </div>
                                                    <span class="rounded-circle border border-2 border-white bg-primary btn-sm-square text-white position-absolute" style="top: 10%; right: -10px;">3</span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="row g-4 align-items-center features-item">
                                            <div class="col-4">
                                                <div class="rounded-circle position-relative">
                                                    <div class="overflow-hidden rounded-circle">
                                                        <img src="assets/img/features-life-style.jpg" class="img-zoomin img-fluid rounded-circle w-100" alt="">
                                                    </div>
                                                    <span class="rounded-circle border border-2 border-white bg-primary btn-sm-square text-white position-absolute" style="top: 10%; right: -10px;">3</span>
                                                </div>
                                            </div>
                                            ...
                                            <ul class="nav nav-pills d-inline-flex text-center mb-4">
                                                <li class="nav-item mb-3">
                                                    <a class="d-flex py-2 bg-light rounded-pill me-2" href="#">
                                                        <span class="text-dark link-hover" style="width: 90px;"><?= $k['nama_kategori'] ?></span>
                                                    </a>
                                                </li>
                                            <?php } ?>
                                            </ul>
